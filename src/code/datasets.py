...
def get_normalize_layer(dataset: str) -> torch.nn.Module:
    ...
    if dataset == "imagenet":
        ...
        return NormalizeLayer(_FaceForensics_MEAN, _FaceForensics_STDDEV)
...
def get_input_center_layer(dataset: str) -> torch.nn.Module:
    ...
    if dataset == "imagenet":
        ...
        return InputCenterLayer(_FaceForensics_MEAN, _FaceForensics_STDDEV)
...
_FaceForensics_MEAN = [0.5, 0.5, 0.5]
_FaceForensics_STDDEV = [0.5, 0.5, 0.5]
